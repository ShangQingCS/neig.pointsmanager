										...
										<ul class="category-list" id="js_climit_li">
											<li class="appliance js_toggle relative first">
												<div class="category-info">
													<h3 class="category-name b-category-name"><%-- <i><img src="${path }/images/cake.png"></i> --%><a title="点心">点心/蛋糕</a></h3>
													<em>&gt;</em>
												</div>
											...
											<li class="appliance js_toggle relative">
												<div class="category-info">
													<h3 class="category-name b-category-name"><%-- <i><img src="${path }/images/meat.png"></i> --%><a title="熟食、肉类">熟食/肉类</a></h3>
													<em>&gt;</em>
												</div>
												<div class="menu-item menu-in top">
													<div class="area-in">
				...
				<div id="f1">
					...
					<div class="am-g am-g-fixed floodFour">
						...
						<div class="am-u-sm-7 am-u-md-4 text-two">
							...
							<a href="introduction.html"><img src="${path }/images/1.jpg" /></a>
						</div>
						<div class="am-u-sm-7 am-u-md-4 text-two">
							<div class="outer-con ">
								<div class="title ">
							...
							<a href="introduction.html"><img src="${path }/images/3.jpg" /></a>
						</div>
						<div class="am-u-sm-7 am-u-md-4 text-two">
							<div class="outer-con ">
								<div class="title ">
							...
							<a href="introduction.html"><img src="${path }/images/4.jpg" /></a>
						</div>
						<div class="am-u-sm-7 am-u-md-4 text-two">
							<div class="outer-con ">
								<div class="title ">
							...
							<a href="introduction.html"><img src="${path }/images/5.jpg" /></a>
						</div>
						<div class="am-u-sm-7 am-u-md-4 text-two">
							<div class="outer-con ">
								<div class="title ">
