		...
		<script>
			$(function(){
				$("#data-am-selected").change(function(){
					...
					if(dateCode==0){
						window.location.href="${path }/asset_web/walletlist.do?dateCode=0&type=2";
					}else if(dateCode==1){
						window.location.href="${path }/asset_web/walletlist.do?dateCode=1&type=2";
					}else if(dateCode==2){
						window.location.href="${path }/asset_web/walletlist.do?dateCode=2&type=2";
					}else{
						window.location.href="${path }/asset_web/walletlist.do?dateCode=3&type=2";
					}
 				});
			});
		</script>
			...
			<div class="col-main">
				<div class="main-wrap">
					<div class="am-cf am-padding">
						<div class="am-fl am-cf"><strong class="am-text-danger am-text-lg">分红明细</strong> / <small>Electronic&nbsp;bill</small></div>
					</div>
					<hr>
					<div class="finance">
					...
					<div class="walletList">
						...
						<c:forEach items="${walletList}" var="mywallet">
							...
							<c:if test="${mywallet.purseType=='2'}">
