...
<div class="am-container header" >
	...
	<ul class="message-r" >
		 <div class="topMessage home">
			<div class="menu-hd"><a href="${path }/index_web/home.do" target="_top" class="h" style="color:red">商城首页</a></div>
		</div> 
		...
		<div class="topMessage my-shangcheng">
			<div class="menu-hd MyShangcheng"><a href="${path }/login_web/loginout.do" target="_top">退出</a></div>
		</div>
